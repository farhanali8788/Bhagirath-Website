      ...
      <section className="ct-main">
        <div className="container ct-main__grid">
          ...
          >
              ...
              <ul className="ct-info__list">
                <li className="ct-info__item">
                  ...
                  <div>
                    ...
                    <a href="tel:+919999999999" className="ct-info__value">
                      +91 99999 99999
                    </a>
                  </div>
                </li>
                <li className="ct-info__item">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@bhagirathrealty.com" className="ct-info__value">
            ...
            {/* WhatsApp */}
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="ct-whatsapp">
              ...
              <div className="ct-whatsapp__text">
                <span className="ct-whatsapp__label">Chat with us instantly</span>
          ...
          >
            <div className="ct-form-card">
              ...
              <p className="ct-form-card__sub">We typically respond within 24 hours.</p>
              ...
              {status === "success" ? (
                <div className="ct-form__success">
                  <div className="ct-form__success-icon">
                    <svg viewBox="0 0 52 52" fill="none" width="48" height="48">
                      ...
                      <path d="M14 26l8 8 16-16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="ct-form" noValidate>
                  {/* Name */}
                  <div className={`ct-field ${touched.name && !formData.name ? "ct-field--error" : ""}`}>
                    ...
                    {touched.name && !formData.name && (
                      <span className="ct-field__err">Please enter your name</span>
                    )}
                  </div>

                  {/* Phone + Email */}
                  <div className="ct-form__row">
                    <div className={`ct-field ${touched.phone && !formData.phone ? "ct-field--error" : ""}`}>
                      ...
                      {touched.phone && !formData.phone && (
                        <span className="ct-field__err">Please enter your phone</span>
                      )}
                    </div>
                    <div className={`ct-field ${touched.email && !formData.email ? "ct-field--error" : ""}`}>
                      ...
                      {touched.email && !formData.email && (
                        <span className="ct-field__err">Please enter your email</span>
                      )}
                    </div>
                  </div>
                  ...
                  {/* Message */}
                  <div className={`ct-field ${touched.message && !formData.message ? "ct-field--error" : ""}`}>
                    ...
                    {touched.message && !formData.message && (
                      <span className="ct-field__err">Please enter a message</span>
                    )}
                  </div>
