...
const projects = [
  ...
  "Bhagirath Heights — Apartments",
  "Bhagirath Commerce Park — Commercial",
  "General Enquiry",
];
    ...
    <div className="ct-page">
      ...
      <section className="ct-hero">
        <div className="ct-hero__bg">
          <img src="/images/about-hero.jpg" alt="Contact Bhagirath Realty" />
          ...
          >
            <div className="ct-form-card">
              ...
              >
                ...
                {/* Status messages */}
                {status === "success" && (
                  <div className="ct-form__status ct-form__status--success">
